...
contract Combination {
    ...
    uint8 private leverPos; // 0b_0010_0000
    ...
    uint8 private pins;     // 0b_1011_0100
    // uint8 private key;   // 0b_0100_1011
    ...
    constructor (uint8 _leverPos, uint8 _val1, uint8 _val2, uint8 _val3, uint8 _pins) {
        // 32,2,8,2,180
        leverPos = _leverPos;   // 32  00100000
        cam1Tab = _val1;        // 2   00000010 needs to be << 4
        cam2Tab = _val2;        // 8   00001000 needs to be << 2
        cam3Tab = _val3;        // 2   00000010 needs to be << 4
    ...
    function dial(uint8 _rotateVal, bool _direction) public {
        ...
        setCamValues(); // rotates left 5,3,5
    }
